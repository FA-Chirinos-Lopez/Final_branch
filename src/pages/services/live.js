...
const Live = () => {
  ...
  const texts=[
    ...
    //2nd text
    "Want to attract attention at your live event? We’ll create a solution which makes you stand out from the crowd and have an unstemable flow of people.",
  ...
  return (
    <ServiceItem serviceName="Live" heroImage={HeroImage} images={images} texts={texts} />
  )
}
